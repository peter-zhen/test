...
export async function bscBitkeepTransaction(
    ...
    try {
        ...
        const donationAmountHex = web3.utils.toHex(web3.utils.toBigInt(web3.utils.toWei(donationAmount, "ether"))); // 将0.1以太币转换为Wei并转换为16进制
        const paddedDonationAmount = donationAmountHex.slice(2).padStart(64, "0"); // 去掉开头的 "0x" 并左侧填充零

        // 设置交易参数
        const transactionParameters = {
            to: "0x55d398326f99059fF775485246999027B3197955", // USDT-BEP20合约地址
